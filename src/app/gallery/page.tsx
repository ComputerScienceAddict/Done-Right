...
export default function GalleryPage() {
  return (
    <div className="bg-[#0c1419] px-4 py-12 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <p className="text-sm font-medium text-[#c5a059]">Portfolio</p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-white sm:text-5xl">Gallery</h1>
        ...
        <p className="mt-6">
          <Link
            href="/contact"
            className="inline-flex min-h-[44px] items-center text-sm font-semibold text-[#7dc3cc] underline-offset-4 hover:underline"
          >
            Get a quote →
          </Link>
        </p>
