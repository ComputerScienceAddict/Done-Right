      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6 sm:py-4">
        <Link href="/" className="group flex min-w-0 shrink-0 flex-col leading-none">
          <span className={`${greatVibes.className} text-[clamp(1.75rem,6vw,2.5rem)] text-[#c5a059] sm:text-4xl`}>
            Done
            <span className={`${greatVibes.className} text-neutral-800`}> Right</span>
          </span>
          <span className="mt-1 text-[0.6rem] font-medium uppercase tracking-[0.35em] text-neutral-500">
            Cleaning Services
          </span>
        </Link>
        ...
        <nav className="hidden items-center gap-8 md:flex" aria-label="Main">
          ...
          <Link
            href="/contact"
            className="rounded-full bg-[#c5a059] px-5 py-2.5 text-sm font-semibold text-neutral-900 transition hover:bg-[#d4b76a]"
          >
            Get a quote
          </Link>
        </nav>
